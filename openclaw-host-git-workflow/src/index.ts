...
export default definePluginEntry({
	...
	description:
		"Host-backed git workflow scaffold for repo-aware planning, repo resolution, node selection, host preflight, bounded branch entry, bounded push, bounded PR creation, checks wait, merge, and sync-main.",
