...
- prepare the short Markdown text used for GitHub Release first, plus the mandatory companion ClawHub worksheet and the fresh package archive, and then any real manual ClawHub release or archive upload flow when explicitly needed
