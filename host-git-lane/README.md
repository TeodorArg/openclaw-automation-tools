...
- `openclaw-host-git-workflow/` is the materialized standalone plugin package that already owns bounded planning, repo resolution, node selection, host preflight, push, PR creation, required-check waiting, merge, and sync-main runtime behavior
