...
- `openclaw-host-git-workflow/` is the active standalone plugin package that owns bounded planning, bounded branch entry, and the bounded host-backed finish flow
