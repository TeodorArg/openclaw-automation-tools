...
If a future standalone host git package manifest appears in canonical source, this companion-layer classification may need revision.
Until that happens, this folder remains documentation-only.
